...
<html>
	...
	<body>
		...
		<div id="edit-educationLevel" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${educationLevelInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${educationLevelInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${educationLevelInstance?.version}" />
				<fieldset class="form">
