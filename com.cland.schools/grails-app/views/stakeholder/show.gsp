	...
	<body>
		...
		<div id="show-stakeholder" class="content scaffold-show" role="main">
			...
			<ol class="property-list stakeholder">
				...
				<g:if test="${stakeholderInstance?.name}">
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="stakeholder.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${stakeholderInstance}" field="name"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${stakeholderInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
